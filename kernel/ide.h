...
typedef enum {
    ata_access_read  = 0x20,
    ata_access_write = 0x30
} ata_access;
...
#define ATA_IDENTIFY_CYLINDER_OFFSET          2
#define ATA_IDENTIFY_HEAD_OFFSET              6 
#define ATA_IDENTIFY_MAX_LBA                  120
#define ATA_IDENTIFY_MAX_LBA_EXT              200
#define ATA_IDENTIFY_SECTORS_OFFSET           12
#define ATA_IDENTIFY_COMMAND_SETS             164
#define ATA_IDENTIFY_CAPABILITIES             98
#define ATA_IDENTIFY_CAPABILITIES_BIG_LBA_BIT 26
//big_lba_bit indicates if device supports the 48 bit address ft set
//see below for complete strcut
